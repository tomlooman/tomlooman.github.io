...
{: .notice--info }
If you are installing JetBrains Rider to follow along with my [Unreal Engine C++ Course](https://tomlooman.com/courses/unrealengine-cpp/), you can select the Free license ("Rider Non-commercial") as you are a student using it for educational purposes.
