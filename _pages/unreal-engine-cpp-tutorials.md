...
{: .notice--info }
This project is what you build in the **Professional Game Development in C++ and Unreal Engine 5** Course (minus some of the later additions and experiments found on the Main Branch in GitHub). If you want to learn exactly how to build this, the reasoning behind every line of code, and tons more tips and tricks we cover along the way, check out my **[Unreal Engine C++ course](https://tomlooman.com/courses/unrealengine-cpp/)**!
