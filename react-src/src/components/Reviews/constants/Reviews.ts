...
export const reviews: { [key: string]: Review[] } = {
  ...
  1: [
    ...
    },
    {
      ...
      company: "",
      text: "\"Excellent course! First of all <strong>Tom has an excellent way of presenting the material, being both engaging and informative</strong>.<br/><br/>Personally, I really enjoy how Tom humors the <strong>occasional short detour to explain a concept or feature of the engine. It's those kinds of things that make this course so valuable</strong>, encouraging me to look into and learn every nook and cranny I run into. There's really no substitute for learning a system besides chasing curiosity. It's refreshing to see Tom exemplify that in his lectures. <br/><br/><strong>Tom does an excellent job of introducing challenges that are substantial yet achievable.</strong> He clearly designs his assignments to leverage all the concepts he has taught so far, without leaving me to 'fend for myself' too much.\"",
    ...
    },
    {
      ...
      company: "",
      text: "\"It was great! I needed something that could show me where to start, core concepts, and building blocks of Unreal with C++.<br />As a game developer who has years of experience with some proprietary game engines (C++) and Unity (C#), this course was spot on!\"",
